  ...
  return (
    <>
      <button
        ...
        className="fixed top-4 right-4 z-40 w-10 h-10 rounded-lg flex items-center justify-center bg-white border border-gray-200 shadow-sm text-gray-500 hover:text-gray-900 hover:border-gray-300 transition-all"
      >
        <History size={16} />
        {entries.length > 0 && (
